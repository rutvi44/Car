...
namespace A4JasoliyaJMistryR
{
    internal class Program
    {
        ...
        static void EditExistingCar()
        {
            ...
            if (carIndex == -1)
            {
                Console.WriteLine("Car not found.Press any key to return to the main menu");
                Console.ReadKey();
                return;
            }
            ...
            while (newYear == 0)
            {
                ...
                if (int.TryParse(Console.ReadLine(), out newYear))
                {
                    ...
                    {
                        Console.WriteLine("Invalid year. Please enter a year between 1900 and 2100.");
                        newYear = 0;
                    }
                }
                else
            ...
            Console.WriteLine("Record updated. Please press any key to retun to the main menu");
            Console.ReadKey();
